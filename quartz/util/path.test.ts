  ...
  test("slugifyFilePath", () => {
    asserts(
      [
        ...
        ["note with – en dash.md", "note-with---en-dash"],
        ["note with — em dash.md", "note-with---em-dash"],
        ['note with "quotes".md', "note-with-quotes"],
        ["note with \u201Ccurly quotes\u201D.md", "note-with-curly-quotes"],
      ],
