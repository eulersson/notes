...
### 🔵 Nouns → fold your arms like a statue

door · window · clock · table · book · pencil · ball · shoe · elephant · tiger · snake · monkey · dragon · dinosaur · rabbit · Monday · music · holiday · dream _(The animals are the trap — kids itch to roar or hop; folding arms on "tiger!" is the self-control that proves they clocked a noun. The classroom objects they can point at instead.)_
...
### 🟦🟥🟩⬛ Colour Paddles — "Show Me the Type" (calm, seated, everyone answers)

Doubles as **Round 1 (the "recognise" warm-up) in the flow above**, and it's the low-chaos stand-in for the relay when there's no room to run — no running, no pile-ups at the board. Give **each team a set of four cardboard sheets — blue, red, green, black** (the same colours as your markers).

**Play it:**

1. You call out a word (from the day's bank, off a card, or off the top of your head).
2. Teams get ~3 seconds to confer, then on **"Show me!"** each team raises the **one** colour that matches the word's type.
3. Every team holding up the right colour scores. Instant, visible, and all 25 answer at the same moment.
...
**Lightning mode:** fire words rapidly with no conferring — pure instinct, points pile up fast. A perfect 5-minute warm-up or palate-cleanser between the bigger games.
