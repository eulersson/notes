...
It's very interesting how all of them have a part related to ourselves <i class="b">བདག</i> (it's our speculation) and a part related to others <i class="p">གཞན</i> (we don't control it): <i class="b">ཡོད་</i>ས་<i class="p">རེད།</i> <i class="b">ཡོད་</i>གྱི་<i class="p">རེད།</i>, etc.
