...
#### Questions
- How to use གང་རུང་ (<i class="r">any</i> <i class="g">either</i>) <i class="g">ཡང་ན་ (or)</i>? #tutor
	- A: ཇ་<i class="p">ཡང་ན་</i>འོ་མ 
	- A: There isn't any food ཁ་ལག་<i class="p">གང་ཡང་</i>མི་འདུག་
	- A: gang yang IS ANY, not gang rung
