...
གྱོན་པ། and གོན་པ། are the same with different spellings. I noticed in the CTA Education books use the latter spelling. Another spelling སྐྱོན་པ། suggests dressing another.

རྫི་ག་པོ། apart from handsome can mean "fancy", and it's very useful to use when describing དུག་སློག

Materials (རྒྱུ་ཆ།): འགྱིག (synthetic), སྤྲིན་བལ། (cotton), བལ། (wool), ར་ཡི་སྤུ། (goat fur/hair), དར་གོས། (silk), དངུལ་ (silver), (metal), (wood), (stone).
