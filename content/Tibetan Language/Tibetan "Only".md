...
གཅིག་པུ། (alone) can be used to say "only", and it's more used for persons. The verb is <i class="b">not negated</i>.
...
ལས། (lit. "from") is short form of ལས་མང་བ། and <i class="b">always negates</i> the verb or non-verb.

མ་གཏོགས། ("only", "apart from", "except for", "unless") <i class="b">always negates</i> the verb or non-verb.
